...
public class Quyuchuangguan extends MainActivity {

    //数据库的名称
    public  String DB_NAME = "test.db";
    //数据库的地址
    //public String DB_PATH = "/data/data/com.lgl.answersystem/databases/test.db";
    public  String DB_PATH = "/data/data/com.syneart.app.lemontree/databases/test.db";
    // public String DB_PATH = Contest.getFilesDir().getPath();
...
//在MAINACTIVIY中調用方法
   // public Quyuchuangguan(MainActivity mainActivity, MainActivity mainActivity1) {
     //   super();
    //}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testforplant);
        ...
        btn_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (corrent < count - 1) {
                    ...
                    new AlertDialog.Builder(Quyuchuangguan.this).setTitle("提示").setMessage("已經到達最後一道題，是否退出？")
                    ...
                    if(wrongList.size() == 0){
                        new AlertDialog.Builder(Quyuchuangguan.this).setTitle("提示").setMessage("你好厲害，答對了所有題！")
                                .setPositiveButton("確定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        finish();
                    ...
                    //窗口提示
                    new AlertDialog.Builder(Quyuchuangguan.this).setTitle("恭喜，答題完成！")
                            .setMessage("答對了" + (list.size() - wrongList.size()) + "道題" + "\n"
